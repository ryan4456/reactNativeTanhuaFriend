        ...
        <View style={{ position: 'absolute', width: '100%', height: '50%', bottom: 0, left: 0, backgroundColor: '#fff', paddingLeft: toDp(10), paddingRight: toDp(10) }}>
            ...
            <View style={{ paddingTop: toDp(10), flexDirection: 'row', alignItems: 'center' }}>
                ...
                <View style={{ width: '60%', flexDirection: 'row', alignSelf: 'center', justifyContent: 'space-evenly' }}>
                    <TouchableOpacity onPress={() => setGender(gender === '男' ? '' : '男')} style={{ backgroundColor: gender !== '男' ? '#eee' : 'red', width: toDp(60), height: toDp(60), alignItems: 'center', justifyContent: 'center', borderRadius: toDp(30) }}>
                        <SvgUri width="30" height="30" svgXmlData={male} />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => setGender(gender === '女' ? '' : '女')} style={{ backgroundColor: gender !== '女' ? '#eee' : 'red', width: toDp(60), height: toDp(60), alignItems: 'center', justifyContent: 'center', borderRadius: toDp(30) }}>
            ...
            {/* 确认 */}
            <THButton onPress={() => handleFilterComplete(gender, distance)} text='确认' styles={{marginTop: toDp(20), width: '80%', height: toDp(40), borderRadius: toDp(10), marginLeft: '10%'}}></THButton>
        </View>
    )
}
